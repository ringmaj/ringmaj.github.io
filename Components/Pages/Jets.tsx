...
const description = [
  ...
  "Mode development including Air-to-Air, Sea Surface Search, GMTI (Ground Moving Target Indicator), Air-to-Ground, SAR Maps (Synthetic Aperture Radar), Attack modes, and more modes.",
];
